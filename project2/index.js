...
app.set('port', PORT)
   ...
   .get('/getJournal', validateLogin, getJournal)
   .get('/getSection', validateLogin, getSection)
   .get('/getPage', validateLogin, getPage)
   .get('/getEntries', validateLogin, getEntries)
   .get('/getTextData', validateLogin, getTextData)
   .get('/logout', validateLogin, getLogout)
